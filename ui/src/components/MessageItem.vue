  ...
  <div class="message-item"
    ...
    <div class="message-wrapper">
      ...
      <div class="message-bubble" :class="{ 'image-bubble': message.type === 'image' }">
          ...
          <div v-else>
            ...
            <div v-if="message.reasoning_content" class="reasoning-section">
              <button class="reasoning-header" @click="toggleReasoningContent">
                <svg class="reasoning-icon" :class="{ expanded: !isReasoningExpanded }" width="1rem" height="1rem"
        ...
        <div v-else-if="message.type === 'image'" class="message-image" @click="predivImage(imageSource)">
          <img :src="imageSource" alt="图片消息" />
...
const imageSource = computed(() => props.message.media || props.message.content || '');
